  ...
  return (
    <>
        <div className={`container my-3 text-${props.mode === 'light'? 'dark' : 'white'}`}>
            <div className="mb-3">
                <h1>{props.heading} </h1>
                <textarea className="form-control" style={{backgroundColor: props.mode === 'dark'? '#042743' : 'white', color:props.mode === 'light'? 'black' : 'white' }} placeholder="Enter your text"  onChange={(e) => setText(e.target.value)} id="exampleFormControlTextarea1" rows="8"></textarea>
            </div>
